...
LLMProvider = Literal["openai", "ollama", "deepseek"]
# Backward-compatible alias used by the embedding package.
...
OLLAMA_LLM_NOTES: dict[str, str] = {
    "qwen2.5:0.5b": "~0.4GB, smoke tests only",
    "qwen2.5:1.5b": "~1.0GB, CPU-friendly",
    "qwen2.5:3b": "~2.0GB, verified Phase 6 default",
    "llama3.2:3b": "~2.0GB, better instruction following",
    "llama3.1:8b": "~4.7GB, wants a GPU or 16GB+ RAM",
}
...
class Settings(BaseSettings):
    ...
    hosted_llm_timeout_seconds: float = 120.0
